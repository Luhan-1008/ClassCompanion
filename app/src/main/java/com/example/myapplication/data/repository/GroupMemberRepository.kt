...
class GroupMemberRepository(private val groupMemberDao: GroupMemberDao) {
    ...
    suspend fun updateMemberStatus(groupId: Int, userId: Int, status: MemberStatus, invitedBy: Int? = null) =
        groupMemberDao.updateMemberStatus(groupId, userId, status, invitedBy)
