...
fun EditAssignmentScreen(navController: NavHostController, assignmentId: Int?) {
    ...
    var urgentReminderHours by remember { 
        mutableStateOf(assignment!!.urgentReminderHours) // 从现有任务读取紧急提醒小时数
    }
                    ...
                    onClick = {
                        if (title.isNotBlank()) {
                            ...
                            val updatedAssignment = assignment!!.copy(
                                ...
                                urgentReminderHours = urgentReminderHours, // 保存紧急提醒小时数
                                priority = priority,
                            ...
                            viewModel.updateAssignment(updatedAssignment, context)
