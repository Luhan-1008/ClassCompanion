...
interface GroupInviteRepository : JpaRepository<GroupInviteEntity, Int> {
    fun findByGroupId(groupId: Int): List<GroupInviteEntity>
    fun findByInviteCode(inviteCode: String): GroupInviteEntity?
}
